...
exports.auth = function(event, context) {
  ...
  oktaJwtVerifier
    ...
    .then((jwt) => {
      ...
      policy.allowMethod(AuthPolicy.HttpVerb.PUT, "/api/v1/users/" + uid);
      // allow change own password
      policy.allowMethod(
        AuthPolicy.HttpVerb.POST,
        "/api/v1/users/" + uid + "/credentials/*"
      );
      ...
      policy.allowMethod(
        AuthPolicy.HttpVerb.GET,
        "/api/v1/users/" + uid + "/factors/catalog"
      );
      ...
      policy.allowMethod(
        AuthPolicy.HttpVerb.DELETE,
        "/api/v1/users/" + uid + "/factors/*"
      );
      //retrieve security question list
      policy.allowMethod(
        AuthPolicy.HttpVerb.GET,
        "/api/v1/users/" + uid + "/factors/questions"
      );
